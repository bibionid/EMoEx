...
print('\nWriting to outfile:\t' + sys.argv[1][:-4] + '.5Kb_cisRegions.stranded.bed')
out_file  = open(sys.argv[1][:-4] + '.5Kb_cisRegions.stranded.bed', 'w')
...
#############################NEW CODE##################################################
#######################################################################################
scaff_limits = chromLimitFind(chr_set, genomeLoad(sys.argv[2]))
...
for chrom in sorted(chr_set):
    ...
    ##########
        ...
        for gene in sorted_chrm_list:
            ...
            #this removes genes that start a 0 on a scaffold
                                    ...
                                    if int(gene[1][0][1][2]) >= int(stored_start) > int(gene[1][0][1][1]):
                                        ...
                                        if gene[1][0][1][4] not in remove_list:
                                            if sorted_chrm_list[count-2][1][0][0] not in remove_list:
                                                ...
                                                # if gene_start_zero == 1:
                                                #
                                                #     print('\tGene ' + sorted_chrm_list[count-1][1][0][1][4] + ' stop:\t' + str(sorted_chrm_list[count-1][1][0][1][2]) + '\treplaces with ' +  gene[1][0][1][1])
                                                #     print('\tGene ' + sorted_chrm_list[count-2][1][0][1][4] + ' stop:\t' + str(sorted_chrm_list[count-2][1][0][1][2]) + '\treplaces with ' +  gene[1][0][1][1])
                                                #
                                                #     ###new line
                                                #     print('\t' + str(sorted_chrm_list[count-1]))
                                                #     print('\t' + str(len(sorted_chrm_list[count-1][1][0][1])))
                                                #     # if sorted_chrm_list[count-2][1][0][1][4] not in remove_list:
                                                #     if len(sorted_chrm_list[count-1][1][0][1]) == 6:
                                                #         sorted_chrm_list[count-1][1][0][1][5] = int(gene[1][0][1][1])
                                                #     else:
                                                #         sorted_chrm_list[count-1][1][0][1].append(gene[1][0][1][1])
                                                #
                                                #     # print('\t' + str(sorted_chrm_list[count-2]))
                                                #     if sorted_chrm_list[count-1][1][0][1][4] not in remove_list:
                                                #         stored_start = int(gene[1][0][1][2])
                                                #         stored_stop  = int(gene[1][0][1][1])
                        ...
                        if gene[1][0][1][3] == '+':
                            ...
                            if int(stored_start + 5000) > int(gene[1][0][1][1]) and stored_start < int(gene[1][0][1][2]):
                                ...
                                if dist <= 1:
                                    ...
                                    #     print(str(gene))
                                    #     print('Allowed promoter region is\t' + str(int(dist/2)))
                                    #     if len(sorted_chrm_list[count-1][1]) == 1:
                                    #         print('Gene ' + str(sorted_chrm_list[count-1][1][0][1][4].strip()) + '  stop:  ' + str(sorted_chrm_list[count-1][1][0][1][5]) + '\treplaces with\t' + str(sorted_chrm_list[count-1][1][0][1][2]) + ' + ' + str(int(dist/2)))
                                    #         # print(sorted_chrm_list[count-1])
                                    ...
                                    #         print(int(sorted_chrm_list[count-1][1][0][1][2]) + int(dist/2))
                                    #         sorted_chrm_list[count-1][1][0][1][5] = int(sorted_chrm_list[count-1][1][0][1][2]) + int(dist/2)
                                    #         stored_start = int(gene[1][0][1][1])
                                    #         stored_stop  = int(gene[1][0][1][2])
                                    #         print('\n')
                                    #     elif len(sorted_chrm_list[count-1][1]) == 2:
                                    #         if dup[1][3] != sorted_chrm_list[count-1][1][0][1][3]:
                                    #             try:
                                    #                 print('Gene ' + str(sorted_chrm_list[count-1][1][0][1][4]) + '  stop:  ' + str(sorted_chrm_list[count-1][1][0][1][5]) + '\treplaces with\t' + str(sorted_chrm_list[count-1][1][0][1][2]) + ' + ' + str(int(dist/2)))
                                    #                 # print(sorted_chrm_list[count-1])
                                    #             except(IndexError):
                                    #                 print('\n\t!!! Missing annotation appended to dup 1...\n')
                                    #                 sorted_chrm_list[count-1][1][0][1].append(int(sorted_chrm_list[count-1][1][0][1][2]) + int(dist/2))
                                    #         else:
                                    #             try:
                                    #                 print('Gene ' + str(sorted_chrm_list[count-1][1][1][1][4].strip()) + '  stop:  ' + str(sorted_chrm_list[count-1][1][1][1][5]) + '\treplaces with\t' + str(sorted_chrm_list[count-1][1][1][1][2]) + ' + ' + str(int(dist/2)))
                                    #             except(IndexError):
                                    #                 print('\n\t!!! Missing annotation appended to dup 2...\n')
                                    #                 sorted_chrm_list[count-1][1][1][1].append(int(sorted_chrm_list[count-1][1][1][1][2]) + int(dist/2))
                                    #
                                    #         # print(sorted_chrm_list[count-1])
                                    #         print('Gene ' + gene[1][0][1][4] + ' start:  ' + str(gene[1][0][1][1]) + '\treplaces with\t' + str(gene[1][0][1][1]) + ' - ' + str(int(dist/2)))
                                    #         gene[1][0][1].append(int(gene[1][0][1][1]) - int(dist/2))
                                    #
                                    #         try:
                                    #             print(sorted_chrm_list[count-1][1][1][1][5])
                                    #         except:
                                    #             print('None stored')
                                    #
                                    #         # try:
                                    #         #     sorted_chrm_list[count-1][1][1][1][5] = int(sorted_chrm_list[count-1][1][1][1][2]) + abs(int(dist/2))
                                    #         # except(IndexError):
                                    #         #     print('\n\t!!! Missing annotation appended to dup 2...\n')
                                    #         #     sorted_chrm_list[count-1][1][1][1].append(int(sorted_chrm_list[count-1][1][1][1][2]) + abs(int(dist/2)))
                                    #         #     sys.exit
                                    #
                                    #
                                    #         stored_start = int(gene[1][0][1][1])
        ...
        # print(' -- 20kb promoter regions retreived for ' + chrom + ' genes.\n')

        print('\nWriting to:\t' + sys.argv[1][:-4] + '5Kb_cisRegions.stranded.bed')
...
####################################################################################################################################################################################
                            ...
                            if int(res[1][5]) > int(scaff_limits[res[1][0]]):

                                print('\n\n\n END OF SCAFF REACHED  -- CLIPPING STOP ANNOT FROM ' + str(res[1][5]) + ' to ' + str(scaff_limits[res[1][0]]) + '\n\n\n')
                                # time.sleep(2)

                                out_file.write(res[1][0] + '\t' + str(int(res[1][2])) + '\t' + str(scaff_limits[res[1][0]]) + '\t' + str(res[0]) + '\t1\t' + str(res[1][3]) + '\n')
...
####################################################################################################################################################################################
                        ...
                        if int(bit[1][0][1][5]) > int(scaff_limits[bit[1][0][1][0]]):
                            print('\n\n\n END OF SCAFF REACHED  -- CLIPPING STOP ANNOT FROM ' + str(bit[1][0][1][5]) + ' to ' + str(scaff_limits[bit[1][0][1][0]]) + '\n\n\n')

                            # time.sleep(2)

                            out_file.write(str(bit[1][0][1][0]) + '\t' + str(bit[1][0][1][2]) + '\t' + str(scaff_limits[bit[1][0][1][0]]) + '\t' + str(bit[1][0][1][4].strip()) + '\t1\t' + str(bit[1][0][1][3].strip()) + '\n')
...
with open(sys.argv[1][:-3] + 'same_strand+start.out', 'w') as out2:
